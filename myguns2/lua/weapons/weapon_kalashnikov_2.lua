...
function SWEP:GetViewModelPosition(pos, ang)
	...
	spronetime = 1
	moveside = math.Approach(moveside, -6.62, 5 * FrameTime())
	movevertical = math.Approach(movevertical, 2.25, 2.25 * FrameTime())
	...
	if self:GetOwner():KeyDown(IN_SPEED) then
	    ...
	    turn = math.Approach(turn, -10, 10 * FrameTime())
	...
	spronetime = 1
	moveside = math.Approach(moveside, -4.25, 10 * FrameTime())
