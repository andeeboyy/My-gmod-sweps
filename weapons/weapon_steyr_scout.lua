...
function SWEP:PrimaryAttack()
	...
	AccuracyMeter = AccuracyMeter + 1.5
	...
	if !self:GetOwner():IsNPC() then
    	    self:GetOwner():SetEyeAngles(self:GetOwner():EyeAngles() + Angle(math.Rand(-25, -10), math.Rand(-5, 5), 0))
	end
    else
	if !self:GetOwner():IsNPC() then
    	    self:GetOwner():SetEyeAngles(self:GetOwner():EyeAngles() + Angle(math.Rand(-2, -1), math.Rand(-1, 1), 0))
	end
    end
end
