...
function SWEP:PrimaryAttack()
    ...
    if !self:GetOwner():IsNPC() then
        self:GetOwner():ViewPunch( Angle( AccuracyMeter * -16, math.random(AccuracyMeter * 15, AccuracyMeter * -16), 0 ) )
    end
    local bullet = {}
	bullet.Damage = 5
	bullet.Num = 1
    ...
    self:EmitSound("weapons/pistol/pistol_fire3.wav", 140, 115, 1, CHAN_WEAPON)
