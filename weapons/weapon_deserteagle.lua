...
function SWEP:PrimaryAttack()
    ...
    EmitSound("weapons/explode3.wav", self:GetPos(), 0, CHAN_WEAPON, 1, 140, 0, 75)
    self:EmitSound("weapons/shotgun/shotgun_dbl_fire.wav", 140, 125, 1, CHAN_WEAPON)
...
function SWEP:GetViewModelPosition(pos, ang)
    pos = pos + ang:Right() * -4 + ang:Up() * 0.5 + ang:Forward() * -2
    return pos, ang
end
