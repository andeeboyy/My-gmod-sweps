...
function SWEP:PrimaryAttack()
	...
	ParticleEffect("door_explosion_shockwave", prop:GetPos(), Angle(0, 0, 0))
	ParticleEffect("grenade_explosion_01", prop:GetPos(), Angle(0, 0, 0))
	ParticleEffect("door_explosion_core", prop:GetPos(), Angle(0, 0, -90))
	...
	boom2:SetKeyValue("iMagnitude", 50)
	boom2:SetKeyValue("iRadiusOverride", 1750)
