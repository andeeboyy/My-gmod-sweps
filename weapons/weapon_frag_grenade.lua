...
function SWEP:PrimaryAttack()
	...
	ParticleEffect("explosion_turret_break", prop:GetPos() + offset * 0.5, Angle(0, 0, 0))
	ParticleEffect("striderbuster_explode_dummy_core", prop:GetPos() + offset, Angle(0, 0, 0))
	...
	boom:SetFlags(4)
	boom:SetOrigin(prop:GetPos() + offset)
	boom:SetScale(2000)
	...
	boom2:SetKeyValue("iMagnitude", 200)
