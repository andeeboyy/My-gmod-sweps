...
SWEP.Category = "my guns - Sidearms"
...
function SWEP:PrimaryAttack()
    ...
    EmitSound("weapons/357/357_fire2.wav", self:GetPos(), 0, CHAN_WEAPON, 1, 140, 0, 85)
    self:EmitSound("weapons/smg1/smg1_fire1.wav", 140, 75, 1, CHAN_WEAPON)
